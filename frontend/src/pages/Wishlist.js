...
export default function Wishlist({ user, addToCart, setView, setSelectedProduct, updateWishlistCount }) {
    ...
    <div style={{ padding: '20px' }}>
      ...
      {notification && (
        <div style={{
          ...
          boxShadow: '0 6px 16px rgba(0,0,0,0.15)', fontSize: '14px',
          fontWeight: '600', zIndex: 9999, display: 'flex', alignItems: 'center', gap: '8px'
        }}>
          🔔 {notification}
        </div>
      )}
            ...
            <div key={product._id} style={{
              ...
              <div style={{ position: 'relative' }}>
                ...
                {flagsState[String(product._id)] && (
                  <div style={{
                    ...
                    fontSize: '12px', padding: '6px 0', textAlign: 'center',
                    fontWeight: '600', borderBottomLeftRadius: '10px', borderBottomRightRadius: '10px'
                  }}>
                    {flagsState[String(product._id)] === "new" ? "Now on Sale" : "Price Dropped Further"}
                  </div>
                )}
                {flagsState[String(product._id) + "_stock"] === "back_in_stock" && (
                  <div style={{
                    position: 'absolute', bottom: '0', left: '0', width: '100%',
                    background: 'rgba(209, 250, 229, 0.95)', color: '#065f46',
                    fontSize: '12px', padding: '6px 0', textAlign: 'center',
                    fontWeight: '600', borderBottomLeftRadius: '10px', borderBottomRightRadius: '10px'
                  }}>
                    Back in Stock
                ...
                {Number(product.discount) > 0 && (
                  <span style={{
                    ...
                    color: '#fff', fontSize: '12px', padding: '4px 8px', borderRadius: '6px', fontWeight: '700'
                  }}>
                ...
                {product.stock === 0 && (
                  <span style={{
                    position: 'absolute', top: '10px', left: '10px', background: '#6b7280',
                    color: '#fff', fontSize: '12px', padding: '4px 8px', borderRadius: '6px', fontWeight: '700'
                  }}>
                    Sold Out
                  </span>
              ...
              <button
                ...
                style={{
                  ...
                  backgroundColor: product.stock === 0 ? '#ccc' : '#111', color: '#fff',
                  fontWeight: '700', cursor: product.stock === 0 ? 'not-allowed' : 'pointer', marginTop: '10px'
                }}
              >
